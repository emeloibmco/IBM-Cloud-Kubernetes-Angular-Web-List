...
La presente guía se enfoca en el despliegue de una aplicación Angular en un clúster de Kubernetes. Adicionalmente, se muestran los pasos necesarios para la creación de la imagen de la aplicación, junto con el uso de IBM Cloud Container Registry.

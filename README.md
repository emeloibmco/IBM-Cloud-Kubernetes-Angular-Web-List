...
En la presente guía se muestran los pasos necesarios el despliegue de una aplicación Angular en un clúster de Kubernetes. Adicionalmente, se indica como crear de la imagen Docker de la aplicación, junto con el uso de IBM Cloud Container Registry.

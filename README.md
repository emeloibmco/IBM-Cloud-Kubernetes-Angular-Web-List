...
La presente guía muestra los pasos necesarios para completar el despliegue de una aplicación Angular en un clúster de Kubernetes. Adicionalmente, se inidcan los pasos requeridos para la creación de la imagen Docker de la aplicación, junto con el uso de IBM Cloud Container Registry.
